      ...
      >
        <div className="px-4">
          ...
          <div className="py-2 text-[.85rem] flex items-center gap-2">
            ...
            <span>{moment(post.publish_date).format("LL")}</span>
          </div>
          <h1 className="text-3xl py-2 text-purple-600 font-bold">
            {post.article_title}
          </h1>
          <div className="py-3">
            {post.article_body && HtmlDecoder({ html: post?.article_body! })}
          </div>
          <div className="border my-3 flex gap-2">
            <div className="w-2/5 h-full bg-gray-300 p-4">
              ...
              <div className="text-[.85rem]">
                <span>{`${post.authors?.first_name!} ${post.authors
                  ?.last_name!}`}</span>
              </div>
            </div>
            <div className="p-4">
              ...
              <p>
                ...
                quos sapiente praesentium sint. Voluptas, optio ducimus modi
                officia sunt vel. Quisquam sed nemo nam est laboriosam placeat
