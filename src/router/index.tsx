...
export const router = createBrowserRouter([
	{
		errorElement: <LayoutWrap Component={Homepage} Layout={ErrorPage} />,
		id: 'ErrorPage',
		children: [
			{
				element: (
					<LayoutWrap Component={Homepage} Layout={BaseLayout} />
				),
				id: 'Homepage',
				path: '/',
			...
			{
				element: (
					<LayoutWrap Component={Loanspage} Layout={BaseLayout} />
				),
			...
			{
				element: (
					<LayoutWrap Component={SectorsPage} Layout={BaseLayout} />
				),
